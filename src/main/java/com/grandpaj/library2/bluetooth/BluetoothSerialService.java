...
public class BluetoothSerialService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Constants.TOAST, mContext.getString(R.string.toast_unable_to_connect) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Constants.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Constants.TOAST, mContext.getString(R.string.toast_connection_lost) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            mmInStream = tmpIn;
            iStreamReader = new InputStreamReader(mmInStream);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if (line != null){
                        Message msg = mHandler.obtainMessage(Constants.MESSAGE_READ_LINE);
                        //fill in the message and send it
                        Bundle bundle = new Bundle();
                        bundle.putString(Constants.READ_LINE, line );
                        msg.setData(bundle);
                        mHandler.sendMessage(msg);
                    }
                } catch (IOException e) {
